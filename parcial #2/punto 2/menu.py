    ...
    if msvcrt.getch() == b'\x1b':
        ...
        while True:
            try:
                ...
                if operacion == 1:
                    valor = input("Indique en el contenido del nodo: ")
                    anterior = None
                    ...
                    for c in valor:
                        ...
                        if anterior not in ["+", "-", "*", "/", "^"]:
                            arbol.insertar_derecha(anterior, c)
                            anterior = actual
                        else:
                            arbol.insertar_izquierda(anterior, c)
                            anterior = actual
                    ...
                    if res:
                        print(
                            f"El nodo con valor: {nodo_buscar} esta dentro del arbol")
                    else:
                        print(f"{nodo_buscar} No esta dentro de el arbol")
                elif operacion == 3:
                    nodo_eliminar = input("Indique el nodo a eliminar: ")
                    ...
                    print(
                        f"El numero de nodos dentro de el arbol es: {arbol.num_nodos}")
                elif operacion == 8:
